...
function lintCommit(criteria) {
    unitChecks(criteria);
    integrationCheck({ commitMessage, reconstructedMessage });
    if (exitCode) {
        utils.printEach(results);
    }
